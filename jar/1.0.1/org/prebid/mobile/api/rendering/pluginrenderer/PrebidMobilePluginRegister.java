...
public class PrebidMobilePluginRegister {
    ...
    private final HashMap<String, org.prebid.mobile.api.rendering.pluginrenderer.PrebidMobilePluginRenderer> plugins = new HashMap<>();
    ...
    public void unregisterEventListener(String listenerKey) {
        for (Map.Entry<String, PrebidMobilePluginRenderer> entry : plugins.entrySet()) {
            org.prebid.mobile.api.rendering.pluginrenderer.PrebidMobilePluginRenderer renderer = entry.getValue();
    ...
    public PrebidMobilePluginRenderer getPluginForPreferredRenderer(BidResponse bidResponse) {
        ...
        org.prebid.mobile.api.rendering.pluginrenderer.PrebidMobilePluginRenderer preferredPlugin = plugins.get(preferredRendererName);
